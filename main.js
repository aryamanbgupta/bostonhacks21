...
function timer(){
    ...
    if(wm.innerText == 0 && ws.innerText == 0 && bm.innerText == 0 && bs.innerText == 0){
        ...
        document.getElementById('points-counter').innerText.value += 1000;

        bull.src.replace("https://img.icons8.com/external-vitaliy-gorbachev-lineal-color-vitaly-gorbachev/60/000000/external-grinning-bull-emoji-vitaliy-gorbachev-lineal-color-vitaly-gorbachev-1.png", "https://icons8.com/icon/yVeWcyC8WBRz/hide");
